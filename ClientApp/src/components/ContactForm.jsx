import React from 'react';
 ...
 const ContactForm = () => {
   return (
     ...
     >
       <Form className='w-[90%] flex flex-col pt-2 2xl:gap-7'>
        <div>
        ...
        <div>
         ...
         <button type="submit" className='w-[200px] h-[55px] bg-[#01B1B0] text-[#FCFBFE] rounded-lg font-normal text-lg self-end'>Enviar</button>
       </Form>
     </Formik>
   );
 };

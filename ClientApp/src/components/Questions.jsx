...
function Questions({title, description, active, setActive}){
        ...
        return (<div className='flex justify-center flex-col m-auto bg-[#ffffff15] overflow-hidden rounded-lg w-[19rem] '>
                    <div  className=' bg-white h-[4rem] w-full'>
                            <div className='border-[0.2px] border-slate-400 bg-white flex flex-row items-center shadow-md shadow-slate-400 h-[100%] cursor-pointer' onClick={()=> setActive(title)}>

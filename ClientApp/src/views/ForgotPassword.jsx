...
function ForgotPassword(){
    ...
    return(
        <>
            <div className="container w-11/12 h-screen flex justify-center m-auto py-24 " >
                <div className="m-auto shadow-lg shadow-gray-700 w-3/5 h-2/5 rounded-lg border border-solid border-gray-200" >
                    ...
                    <form className="m-5" >
                        <input className="rounded-lg w-3/4 border-2 border-solid border-teal-600 h-9 px-3" type='text' name="user" id="user" placeholder="Correro electrónico o nombre de usuario" />

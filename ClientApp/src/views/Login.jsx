                ...
                <div className=" bg-neutral-50 m-auto w-2/3 h-5/6 rounded-md shadow-slate-600 shadow-lg" >
                    <div className="flex flex-row h-full rounded-md shadow-slate-500">
                         <div className="w-2/4 h-full rounded-md shadow-slate-600 shadow-lg overflow-hidden"> 
                            <img src={dog} className="object-cover -my-8" />
                        ...
                        <div className="p-6 m-auto w-2/4 h-full flex flex-col justify-center gap-1">
                            ...
                            <div className=" w-full">
                                ...
                                <input className="border-2 rounded-md border-solid border-teal-600 w-full h-9 px-3" placeholder="correo@correo.com" type="email"  />
                            </div>
                            <div className=" w-full">
                                <p className="my-3 font-semibold">Contraseña</p>
                                <div>
                                    <input className="border-2 rounded-md border-solid border-teal-600 w-full h-9 px-3" placeholder="********" type={password} />
                            ...
                            <button className="flex justify-center mx-auto -mt-8 text-white text-sm bg-teal-500 hover:bg-teal-400 duration-150 rounded-md w-36 h-10 p-2" >Acceder</button>
